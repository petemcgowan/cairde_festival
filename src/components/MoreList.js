...
const generalStyleData = [
  {
    ...
    qaList: [
      ...
      {
        question: 'Do I need a COVID vaccine / recovery pass or antigen test?',
      ...
      {
        question: 'How do I know if this show is appropriate for my children?',
      ...
      {
        question: 'I know this show is sold out, but surely there’s room for one more?',
      ...
      {
        question: 'Where can I submit my work for consideration in the Festival?',
      ...
      {
        question: 'Where can I buy Festival merchandise and gift vouchers?',
  ...
  },
  {
    ...
    description: `
    Irish Independent:
    https://www.independent.ie/regionals/sligochampion/news/packed-programme-for-sligos-cairde-arts-festival-2022-41769951.html

    Irish Independent:
    https://www.independent.ie/regionals/sligochampion/news/cairde-sligo-arts-festival-is-in-full-swing-with-entertainment-for-all-ages-41816377.html
    Sligo Weekender:
    http://sligoweekender.ie/2016/07/06/cairde-close-party/

    Tripadvisor: https://www.tripadvisor.ie/ShowTopic-g186635-i1128-k14009631-Cairde_Sligo_Arts_Festival_starts_this_weekend-Sligo_County_Sligo_Western_Ireland.html

    Sligo Weekender:
    http://sligoweekender.ie/2016/06/22/cairde-sligo-arts-festival-music-line-up-hits-all-the-right-notes/

    Irish Independent:
    https://www.independent.ie/regionals/sligochampion/news/experiences-and-fun-for-all-ages-at-cairde-arts-festival-41740270.html

    Irish Independent: https://www.independent.ie/regionals/sligochampion/news/siomha-and-nava-link-up-in-rich-double-bill-at-cairde-fest-41798536.html

    RTE: https://www.rte.ie/culture/2022/0627/1306334-cairde-sligo-arts-festival-culture-connection-and-craic/

    Irish Independent:
    https://www.independent.ie/regionals/sligochampion/news/countdown-is-on-as-cairde-sligo-arts-festival-starts-this-weekend-41794722.html

    Irish Independent: https://www.independent.ie/regionals/sligochampion/news/new-artistic-works-for-cairde-arts-fest-41740157.html

    Writing Ireland:
    https://www.writing.ie/guest-blogs/cairde-sligo-arts-festival-returns-as-a-fully-live-event-1-10-july/
    `,
    component: null,
    link: null,
    icon: faNewspaper,
...
export default ({ navigation }) => {
    ...
    return (
      <View>
        <View style={{ backgroundColor: offWhite }}>
          <TouchableOpacity onPress={onPressGeneralItem} style={[styles.container, { margin: 10 }]}>
            <View style={[styles.content, { flexDirection: 'row', alignItems: 'center' }]}>
              ...
              <FontAwesomeIcon style={{ width: '20%' }} icon={faChevronRight} size={24} color="orange" />
            </View>
          </TouchableOpacity>
        </View>
        <Separator />
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: offWhite }}>
      <FlatList data={generalStyleData} renderItem={renderItem} keyExtractor={(item) => item.id} />
    </View>
  );
};
